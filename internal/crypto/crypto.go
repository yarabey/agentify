...
// машины, FR B6, тикет 2.3), либо зашифрованы at-rest без необходимости
// показа наружу (текст задачи tasks.text_enc и содержимое событий
// task_events.payload_enc, FR I1, тикет 11.1). Этот пакет —
